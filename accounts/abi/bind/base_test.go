...
func TestTransactGasFee(t *testing.T) {
	...
	// GasTipCap and GasFeeCap When opts.GasTipCap and opts.GasFeeCap are nil
	// GasTipCap 和 GasFeeCap 当 opts.GasTipCap 和 opts.GasFeeCap 为零时
	...
	// 第二次调用 Transact 应使用最新建议的 GasTipCap
	...
	// GasPrice When opts.GasPrice is nil
	// GasPrice 当 opts.GasPrice 为零时
	...
	// 第二次调用 Transact 应使用最新建议的 GasPrice
...
// TestCrashers 包含一些先前导致 abi 编解码器崩溃的字符串。
