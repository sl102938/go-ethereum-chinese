...
// typeWithoutStringer is a alias for the Type type which simply doesn't implement the stringer interface to allow printing type details in the tests below.
// typeWithoutStringer 是 Type 类型的别名，它根本不实现 stringer 接口以允许在下面的测试中打印类型详细信息。
...
func TestTypeRegexp(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO when fixed types are implemented properly {"fixed", nil, Type{}}, {"fixed128x128", nil, Type{}}, {"fixed[]", nil, Type{}}, {"fixed[2]", nil, Type{}}, {"fixed128x128[]", nil, Type{}}, {"fixed128x128[2]", nil, Type{}},
		// 正确实现固定类型时的 TODO {"fixed", nil, Type{}}, {"fixed128x128", nil, Type{}}, {"fixed[]", nil, Type{}}, {"fixed[2 ]", nil, 类型{}}, {"fixed128x128[]", nil, 类型{}}, {"fixed128x128[2]", nil, 类型{}},
