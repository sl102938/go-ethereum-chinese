...
func TestImportPreSaleKey(t *testing.T) {
	...
	// file content of a presale key file generated with: python pyethsaletool.py genwallet with password "foo"
	// 使用以下命令生成的预售密钥文件的文件内容： python pyethsaletool.py genwallet，密码为“foo”
...
// 以太坊 JSON 测试中密钥存储测试的测试和实用程序； testdataKeyStoreTests/basic_tests.json
